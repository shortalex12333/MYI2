        ...
        return (
          ...
          >
            <button
              ...
              className="w-full text-left rounded-lg bg-gray-100  border border-gray-200 hover:border-brand-blue/50 transition-all p-6"
            >
                      ...
                      <div className="prose prose-invert prose-sm max-w-none">
                        <ReactMarkdown
                          components={{
                            ...
                            ul: ({ children }) => (
                              <ul className="list-disc list-inside text-gray-900/80 space-y-2 mb-4">
                                {children}
                              </ul>
                            ),
                            ol: ({ children }) => (
                              <ol className="list-decimal list-inside text-gray-900/80 space-y-2 mb-4">
                                {children}
                              </ol>
                            ),
                            li: ({ children }) => (
                              <li className="text-gray-900/80">{children}</li>
                            ),
                            strong: ({ children }) => (
